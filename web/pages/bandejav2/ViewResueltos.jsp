...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    Bandeja de documentos resueltos
    ...
    <%@include file="modals/bandeja/modalDetalleMensaje2.html" %>
    ...
    <script src="${pageContext.request.contextPath}/js/tramite/bandejav2/bandeja/JSResueltos.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/tramite/bandejav2/bandeja/JSBusquedaBandejaResueltos.js" type="text/javascript"></script>
