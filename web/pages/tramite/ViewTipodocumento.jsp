...
<html>
    <meta charset="UTF-8">
    <title>Registro Tipodocumento</title>
...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    <small>Administracion de Tipo de Documento</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-unlock-alt"></i> Tipo de Documento</a></li>
                    <li class="active">Registro de Tipo de Documento</li>
                </ol>
            </section>
            <!-- Main content -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Lista de Tipo de Documento</h3>
                            </div>
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Tipo de Documento</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
                                    ...
                                    <div class="form-group col-md-4">
                                        <label>Mayor </label>
                                        <input  id="txtbsubida" type="checkbox">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Menor </label>
                                        <input  id="txtbbajada" type="checkbox">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Igual </label>
                                        <input  id="txtbigual" type="checkbox">
                                    </div>
                                    <!--<div class="form-group">
                                        <label>Es jefe :</label>
    ...
    <script src="${pageContext.request.contextPath}/js/tramite/JSTipodocumento.js" type="text/javascript"></script>
