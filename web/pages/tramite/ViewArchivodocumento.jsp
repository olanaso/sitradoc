...
<html>
    <meta charset="UTF-8">
    <title>Registro Archivodocumento</title>
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    Registro de Archivodocumento
                    <small>Administracion de Archivodocumento</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-unlock-alt"></i> Archivodocumento</a></li>
                    <li class="active">Registro de Archivodocumento</li>
                </ol>
            </section>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Lista de Archivodocumento</h3>
                            </div>
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Archivodocumento</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
   <div class="form-group">
                                        <label>Documento :</label>
                                        <input obligatorio id="txtDocumento" class="form-control input-sm" type="text" placeholder="Ingrese Documento">
                                    </div>   <div class="form-group">
                                        <label>Codigo :</label>
                                        <input obligatorio id="txtCodigo" class="form-control input-sm" type="text" placeholder="Ingrese Codigo">
                                    </div>   <div class="form-group">
                                        <label>Nombre :</label>
                                        <input obligatorio id="txtNombre" class="form-control input-sm" type="text" placeholder="Ingrese Nombre">
                                    </div>   <div class="form-group">
                                        <label>Url :</label>
                                        <input obligatorio id="txtUrl" class="form-control input-sm" type="text" placeholder="Ingrese Url">
                                    </div>                                </div><!-- /.box-body -->
    ...
    <script src="${pageContext.request.contextPath}/js/SISTEMA/JSArchivodocumento.js" type="text/javascript"></script>
