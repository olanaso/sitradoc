...
<html>
    ...
    <link href="${pageContext.request.contextPath}/js/plugins/bootstrap/css/jasny-bootstrap.min.css" rel="stylesheet" type="text/css" />
...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    Registro de Feriado
                    <small>Administracion de feriados</small>
                </h1>
                <ol class="breadcrumb">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Lista de Feriados</h3>
                            </div>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Fecha :</label>
                                        <input obligatorio id="txtFecha" class="form-control input-sm" type="text" data-mask="99/99/9999" placeholder="dd/mm/aaaa" >
                                    </div>   <div class="form-group">
                                        <label>Motivo :</label>
    ...
    <script src="${pageContext.request.contextPath}/js/plugins/bootstrap/js/jasny-bootstrap.min.js" type="text/javascript"></script>
