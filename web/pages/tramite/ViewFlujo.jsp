...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-unlock-alt"></i> Flujo</a></li>
                    <li class="active">Registro de Flujo</li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Flujo</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
 <div class="form-group">
                                        ...
                                        <label>Idestadoflujo :</label>
                                        <select obligatorio id="txtIdestadoflujo" class="form-control input-sm">
                                        </select>
                                    </div> <div class="form-group">
                                        ...
                                        <label>Fechaenvio :</label>
                                        <input obligatorio id="txtFechaenvio" class="form-control input-sm" type="text" placeholder="Ingrese Fechaenvio">
                                    </div>   <div class="form-group">
                                        ...
                                        <input obligatorio id="txtObservacion" class="form-control input-sm" type="text" placeholder="Ingrese Observacion">
                                    </div>   <div class="form-group">
                                        <label>Binderror :</label>
                                        <input obligatorio id="txtBinderror" class="form-control input-sm" type="text" placeholder="Ingrese Binderror">
                                    </div>                                </div><!-- /.box-body -->
    ...
    <script src="${pageContext.request.contextPath}/js/SISTEMA/JSFlujo.js" type="text/javascript"></script>
