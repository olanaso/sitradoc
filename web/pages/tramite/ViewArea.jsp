...
<html>
    <meta charset="UTF-8">
    <title>Registro &Aacute;rea</title>
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    Registro de &Aacute;rea
                    <small>Administraci&oacute;n de &Aacute;reas</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-unlock-alt"></i> &Aacute;rea</a></li>
                    <li class="active">Registro de &Aacute;rea</li>
                </ol>
            </section>
            <!-- Main content -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de &Aacute;rea</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
                                     <div class="form-group">
                                        <label>&Aacute;rea Superior :</label>
                                        <select id="txtIdarea" class="form-control input-sm">
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>C&oacute;digo<i style="color:red ">*</i> :</label>
                                        <input obligatorio solonumeros maxlength="3" id="txtCodigo" class="form-control input-sm" type="text" placeholder="Ingrese C&oacute;digo">
                                    </div>
                                    <div class="form-group">
                                        <label>Denominaci&oacute;n<i style="color:red ">*</i> :</label>
                                        <input obligatorio maxlength="200" id="txtDenominacion" class="form-control input-sm" type="text" placeholder="Ingrese Denominaci&oacute;n">
                                    </div>
                                       <div class="form-group">
                                        <label>Abreviatura<i style="color:red ">*</i> :</label>
                                        <input obligatorio maxlength="20" id="txtAbreviatura" class="form-control input-sm" type="text" placeholder="Ingrese Abreviatura">
                                    </div>  
                                </div><!-- /.box-body -->
