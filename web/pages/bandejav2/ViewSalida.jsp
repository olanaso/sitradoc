...
<body class="skin-blue">
    ...
    <script src="${pageContext.request.contextPath}/js/tramite/bandejav2/bandeja/JSBandejaSalida.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/tramite/bandejav2/bandeja/JSBusquedaBandejaSalida.js" type="text/javascript"></script>
