...
<html>
    <meta charset="UTF-8">
    <title>Registro Estadoflujo</title>
...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    Registro de Estadoflujo
                    <small>Administracion de usuarios</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-unlock-alt"></i> Estadoflujo</a></li>
                    <li class="active">Registro de Estadoflujo</li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Estadoflujo</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
   <div class="form-group">
    ...
    <script src="${pageContext.request.contextPath}/js/SISTEMA/JSEstadoflujo.js" type="text/javascript"></script>
