<%-- 
    Document   : ViewReporteEvento
    Created on : 17-oct-2016, 14:54:11
    Author     : djackob
--%>
...
<html>
    ...
    <body>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Reporte Evento</li>
                    </ol>
                </section>
                <!-- Main content -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Área :</label>
                                                <input obligatorio id="txtCodExpDoc" type="text" class="form-control" placeholder="Ingrese Código de Documento o Expediente">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
        ...
        <script src="${pageContext.request.contextPath}/js/tramite/reporte/JSReporteEvento.js" type="text/javascript"></script>
    </body>
</html>
