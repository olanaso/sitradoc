    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    Registro de Bandeja
                    <small>Administracion de Bandeja</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-unlock-alt"></i> Bandeja</a></li>
                    <li class="active">Registro de Bandeja</li>
                </ol>
            </section>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Lista de Bandeja</h3>
                            </div>
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Bandeja</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
 <div class="form-group">
                                        <label>Iddocumento :</label>
                                        <select obligatorio id="txtIddocumento" class="form-control input-sm">
                                        </select>
                                    </div> <div class="form-group">
                                        <label>Idareaproviene :</label>
                                        <select obligatorio id="txtIdareaproviene" class="form-control input-sm">
                                        </select>
                                    </div> <div class="form-group">
                                        <label>Idareadestino :</label>
                                        <select obligatorio id="txtIdareadestino" class="form-control input-sm">
                                        </select>
                                    </div> <div class="form-group">
                                        <label>Idusuarioenvia :</label>
                                        <select obligatorio id="txtIdusuarioenvia" class="form-control input-sm">
                                        </select>
                                    </div> <div class="form-group">
                                        <label>Idusuariodestino :</label>
                                        <select obligatorio id="txtIdusuariodestino" class="form-control input-sm">
                                        </select>
                                    </div>   <div class="form-group">
                                        <label>Bindrecepcion :</label>
                                        <input obligatorio id="txtBindrecepcion" class="form-control input-sm" type="text" placeholder="Ingrese Bindrecepcion">
                                    </div> <div class="form-group">
                                        <label>Idusuariorecepciona :</label>
                                        <select obligatorio id="txtIdusuariorecepciona" class="form-control input-sm">
                                        </select>
                                    </div>   <div class="form-group">
                                        <label>Fecharecepciona :</label>
                                        <input obligatorio id="txtFecharecepciona" class="form-control input-sm" type="text" placeholder="Ingrese Fecharecepciona">
                                    </div>   <div class="form-group">
                                        <label>Fechalectura :</label>
                                        <input obligatorio id="txtFechalectura" class="form-control input-sm" type="text" placeholder="Ingrese Fechalectura">
                                    </div>   <div class="form-group">
                                        <label>Fechaderivacion :</label>
                                        <input obligatorio id="txtFechaderivacion" class="form-control input-sm" type="text" placeholder="Ingrese Fechaderivacion">
                                    </div>   <div class="form-group">
                                        <label>Fecharegistro :</label>
                                        <input obligatorio id="txtFecharegistro" class="form-control input-sm" type="text" placeholder="Ingrese Fecharegistro">
                                    </div>                                </div><!-- /.box-body -->
    ...
    <script src="${pageContext.request.contextPath}/js/SISTEMA/JSBandeja.js" type="text/javascript"></script>
