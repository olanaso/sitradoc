...
<body class="skin-blue">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    ...
                    <small>Administracion de Referencia</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-unlock-alt"></i> Referencia</a></li>
                    <li class="active">Registro de Referencia</li>
                </ol>
            </section>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Lista de Referencia</h3>
                            </div>
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Referencia</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
 <div class="form-group">
                                        ...
                                        <label>Iddocumentoreferencia :</label>
                                        <select obligatorio id="txtIddocumentoreferencia" class="form-control input-sm">
                                        </select>
                                    </div>   <div class="form-group">
                                        ...
                                        <label>Idusuarioregistra :</label>
                                        <select obligatorio id="txtIdusuarioregistra" class="form-control input-sm">
                                        </select>
                                    </div>                                </div><!-- /.box-body -->
    ...
    <script src="${pageContext.request.contextPath}/js/SISTEMA/JSReferencia.js" type="text/javascript"></script>
