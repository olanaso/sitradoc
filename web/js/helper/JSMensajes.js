...
var Mensajes = {
    ...
    deseaRecibirExpedientes: '¿Desea recibir los Expedientes seleccionados.?',
    deseaRecibirDocumentos: '¿Desea recibir los Documentos seleccionados.?',
    deseaFinalizarDocumento: '¿Desea Finalizar el Documento.?',
    deseaResolverDocumento: '¿Desea Resolver el Documento.?',
    ...
    feriadoDuplicado: '<i style="color:red "class="fa fa-exclamation-triangle fa-2x"></i>  El feriado registrado ya existe.',
    ...
    usuarioActualizar: '<i style="color:red "class="fa fa-exclamation-triangle fa-2x"></i>  El Usuario que desea actualizar ya existe.',
    usuarioDuplicado: '<i style="color:red "class="fa fa-exclamation-triangle fa-2x"></i>  El Usuario que desea registrar ya existe.',
    usuariorolDuplicado: '<i style="color:red "class="fa fa-exclamation-triangle fa-2x"></i>  El Usuario que desea insertar ya tiene asignado el Rol.',
    usuariorolActualizar: '<i style="color:red "class="fa fa-exclamation-triangle fa-2x"></i>  El Usuario que desea actualizar ya tiene asignado el Rol.',
    rolmoduloDuplicado: '<i style="color:red "class="fa fa-exclamation-triangle fa-2x"></i>  El Rol que desea insertar ya tiene asignado el Módulo.',
    rolmoduloActualizar: '<i style="color:red "class="fa fa-exclamation-triangle fa-2x"></i>  El Rol que desea actualizar ya tiene asignado el Módulo.',
    codProcedimientoDuplicado: '<i style="color:red "class="fa fa-exclamation-triangle fa-2x"></i>  El Código del Procedimiento que desea registrar ya existe.',
    sinExpediente: '<i style="color:red "class="fa fa-exclamation-triangle fa-2x"></i> Debe seleccionar al menos un Expediente para recibir',
};
