		...
		function () {
			...
			if (!jQuery('#ptTimeSelectCntr').length) {
				jQuery("body").append(
					...
					+	'					<div class="ptTimeSelectLeftPane" style="width: 65%; text-align: center; float: left;" class="">Hora</div>'
					+	'					<div class="ptTimeSelectRightPane" style="width: 35%; text-align: center; float: left;">Minutos</div>'
					+	'				</div>'
					+	'				<div>'
					...
					+	'								<a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);">24</a>'
 ...
 * 	hoursLabel		-	String. Label for the Hours. (default: Hora)
 * 	minutesLabel	-	String. Label for the Mintues. (default: Minutos)
 * 	setButtonLabel	-	String. Label for the Set button. (default: Seleccionar)
