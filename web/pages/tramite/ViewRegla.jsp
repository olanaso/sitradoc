    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    Registro de Regla
                    <small>Administracion de Regla</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-unlock-alt"></i> Regla</a></li>
                    <li class="active">Registro de Regla</li>
                </ol>
            </section>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Lista de Regla</h3>
                            </div>
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Regla</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
   <div class="form-group">
                                        <label>Subida :</label>
                                        <input obligatorio id="txtSubida" class="form-control input-sm" type="text" placeholder="Ingrese Subida">
                                    </div>   <div class="form-group">
                                        <label>Igual :</label>
                                        <input obligatorio id="txtIgual" class="form-control input-sm" type="text" placeholder="Ingrese Igual">
                                    </div>   <div class="form-group">
                                        <label>Bajada :</label>
                                        <input obligatorio id="txtBajada" class="form-control input-sm" type="text" placeholder="Ingrese Bajada">
                                    </div>                                </div><!-- /.box-body -->
    ...
    <script src="${pageContext.request.contextPath}/js/SISTEMA/JSRegla.js" type="text/javascript"></script>
