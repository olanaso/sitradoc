...
<body class="skin-blue">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    Registro de Usuario Cargo
                    <small>Administracion de usuarios</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-unlock-alt"></i> Usuario Cargo</a></li>
                    <li class="active">Registro de Usuario cargo</li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form id="form" role="form">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Usuario Cargo</h3>
                                </div>
                                <div class="box-body">
                                    <!-- Date range -->
                                    ...
                                    <div class="form-group">
                                        <label>Cargo :</label>
                                        <select obligatorio id="txtIdcargo" class="form-control input-sm select2">
                                        </select>
                                    </div>  
                                                                  </div><!-- /.box-body -->
    ...
    <script src="${pageContext.request.contextPath}/js/tramite/JSUsuariocargo.js" type="text/javascript"></script>
